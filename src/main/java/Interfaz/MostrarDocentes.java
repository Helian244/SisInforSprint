 ...
 * @author Usuario
 */
public class MostrarDocentes extends javax.swing.JFrame {
    Conexion objetoCon = new Conexion();
    Connection conectar = objetoCon.establecerConexion();
    MenuPrincipal men;
    /**
     * Creates new form MostrarDocentes
     */
    public MostrarDocentes(MenuPrincipal men) {
        this.men = men;
        initComponents();
...
//            java.util.logging.Logger.getLogger(MostrarDocentes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new MostrarDocentes().setVisible(true);
//            }
//        });
//    }
